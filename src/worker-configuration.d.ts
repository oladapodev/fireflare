/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 0dd8dd74ad94fe59445ee28cc1ca0cf2)
...
interface __BaseEnv_Env {
	...
	BROWSER_SEARCH_URL: "https://search.brave.com/search?q=";
	JOB_STATUS: DurableObjectNamespace<import("./index").JobStatusObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "JobStatusObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BROWSER_PROVIDER" | "SEARCH_PROVIDER" | "KERNEL_API_BASE" | "BROWSER_SEARCH_URL">> {}
}
